...
* To use a Singularity image, we must first build the image with the [`singularity build`](https://sylabs.io/guides/3.1/user-guide/cli/singularity_build.html) command and the instructions outlined in the definition file. 
