...
The final command becomes: `evergiven adv-tutorial --file-hint {pdb_file} --file-receptor {pdb_file} --hint-radius {float} --hint-molinfo {str} --smiles {str} --output-keys docked_ligand,receptor`
